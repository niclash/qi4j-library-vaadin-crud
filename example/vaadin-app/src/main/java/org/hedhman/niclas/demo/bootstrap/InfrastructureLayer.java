...
public class InfrastructureLayer extends LayeredLayerAssembler
{
    ...
    {
        String configModuleName = createModuleName(InfraConfigModule.class);
        ModuleAssembly configModule = layer.application().layer(ConfigurationLayer.NAME).module(configModuleName);
        createModule(layer, IndexingModule.class, configModule);
